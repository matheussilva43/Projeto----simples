  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        ...
        <!-- Fim navbar -->
<?php
    $con=mysqli_query($con, "SELECT * FROM usuarios ORDER BY 'id'");
      ...
      <div class="col-md-12">
        <table class="table table-hover">
          ...
          <?php while ($linhas= mysqli_fetch_array($con)){?>
              ...
              <td><a href="editar_usuario.php?&id=<?php echo $linhas['id'];?>" class="btn btn-success">Editar</a></td>
              <td>
                  <a href="deletar_usuario.php?&id=<?php echo $linhas['id'];?>" class="btn btn-danger">Apagar</a>
              </td>
