...
<div class="container">
      <form class="form-horizontal" method="post" action="salvar_agendar.php">
    <div class="form-group">
      <label for="data" class="col-sm-2 control-label">Data</label>
    <div class="col-sm-4">
      <input type="date" class="form-control" name="data" placeholder="Selecione a data" required autofocus>
    </div>
  </div>
    <div class="form-group">
      <label for="horario" class="col-sm-2 control-label">Horário</label>
    <div class="col-sm-4">
      <input type="time" class="form-control" name="horario" placeholder="Selecione o horario" required autofocus>
    </div>
  </div>
  <div class="form-group">
    <label for="servico" class="col-sm-2 control-label">Escolha o serviço</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" name="servico" placeholder="Selecione o serviço" required autofocus>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="corte" placeholder="Selecione o Corte" required autofocus>
      <!-- <select class="form-control" class="selectpicker">
